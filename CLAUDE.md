...
- 现状:v1 已完结——confidant-v1 决议 + confidant-v1-impl 实施票 01–31 全部提交 master(26–31 为用户复验修复轮),记录见 [docs/tech-debt.md](docs/tech-debt.md) 与 [CONTEXT.md](CONTEXT.md)。**待人工收尾**:票 20 的干净机安装复核与人工首验清单 1–6(清单在票内)、票 21 图标 v2 终稿的实机观感复检(管线与打包复核已完成)、v1 附录 B 画像假设检验(记录单在 [.scratch/confidant-v2/00-persona-check.md](.scratch/confidant-v2/00-persona-check.md),完成后即可开 v2 范围裁决)。
