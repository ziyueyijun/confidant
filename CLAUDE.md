...
**规划阶段接近收尾：spec 已成文，尚未开始实现。**

- **[`docs/spec.md`](docs/spec.md) 是开工依据**——覆盖 MVP 的完整 spec：要做什么、怎么做、怎么算做完。动手前读它，不要从零推导。
- 规划过程的决策与理由在 [wayfinder map](https://github.com/ziyueyijun/confidant/issues/20)（#20）下逐项归档；map 上仅剩[同步的用户界面](https://github.com/ziyueyijun/confidant/issues/19)一张票未解决。
